...
const char* RUN_ID          = "GAP_SWEEP_001";
const char* GAP_DISTANCE    = "25.4um";       // UPDATE for each gap!
const char* MATERIAL_PAIR   = "SiO2-SiO2";
const char* SPACER_TYPE     = "1mil_shim";    // UPDATE for each gap!
const int   RUNS_PER_GAP    = 3;              // 3 runs for statistics
